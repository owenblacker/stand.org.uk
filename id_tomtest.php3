...
print ("It's " . ($ds_until * $factor) . " days, " . ($factor * $hs_until) . " hours, " . ($ms_until * $factor) . " minutes and " . ($factor * $ss_until) . " seconds until David Blunkett stands up and claims that the UK likes the idea of ID cards"
?> 

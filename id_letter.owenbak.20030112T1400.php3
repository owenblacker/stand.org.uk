...
?>
		...
		<TR>
		<TD COLSPAN="2"><FONT CLASS="form"><TEXTAREA ROWS="30" COLS="60" MAXLENGTH="20000" NAME="body" CLASS="form" TEXTWRAP="physical" style="background: url(cheapnnasty.gif) repeat-x;" onfocus="this.style.backgroundImage=''; this.style.backgroundColor='white';"><?

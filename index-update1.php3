<? include "config.php3"; ?>
<BASE HREF="http://www.stand.org.uk/">
<html>
<head>
...
<FONT face="Arial, Helvetica, sans-serif"><FONT size=-1><STRONG>========== UPDATE 19 May 1999 ========== <BR><BR>
UK GOVERNMENT REALLY STILL ALMOST ABANDONING KEY ESCROW!
</STRONG><BR><BR>


<BR><BR>Well, not quite: as we've said before, it's not over until it's over.  The
latest good news is that the <A
HREF="http://www.parliament.the-stationery-office.co.uk/pa/cm199899/cmselect/cmtrdind/187/18702.htm">Trade
and Industry Select Committee report</A> has out, and they agree with us:

<BR><BR>"We can see no benefits arising from government promotion of key escrow or key
recovery technology", they say. And then they add that the government
proposals are "not fit to be written into law", and would be a "damaging and
embarrassing failure".

<BR><BR>Thanks to everyone who helped with our <A
HREF="http://www.parliament.the-stationery-office.co.uk/pa/cm199899/cmselect/cmtrdind/187/187ap21.htm">submission
to the Committee</A>. All of your major points were matched in the Committee's
own conclusions.  ("About 180% better than we thought we'd do", reports one
overly-precise correspondent.)

<BR><BR>The bad news is that the government <I>still</I> hasn't confirmed its absolute
rejection of key escrow, nor its abandonment of the remainder of the Bill's
mildly idiotic provisions. 
<BR><BR>
...
data.</FONT></FONT>
    ...
    <TD bgcolor="#FFCC00" valign="TOP" halign="left"><IMG src="images/BlkPixel.gif" width="3" height="2400"> </TD>
